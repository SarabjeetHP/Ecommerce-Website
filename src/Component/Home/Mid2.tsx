...
const cardData: CardData[] = [
  {
    ...
    icon: <span className="text-3xl border border-dotted">⭐</span>, // Replace with actual icon if needed
  },
  {
    title: "Fashion Forward",
    description: "We're more than a brand; we're trendsetters, curating styles that empower and inspire confidence.",
    icon: <span className="text-3xl border border-dotted">👗</span>,
  },
  {
...
const Midd2: React.FC = () => {
  return (
    ...
    <div className="border border-dotted border-gray-700 p-4 max-w-7xl mx-auto">
